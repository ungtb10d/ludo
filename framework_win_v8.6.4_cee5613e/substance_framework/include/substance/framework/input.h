...
enum InputWidget
{
	...
	Input_Togglebutton,     //!< Single On/Off toggle button or checkbox
	Input_Enumbuttons,      //!< Side-by-side buttons for boolean values
...
struct InputDescBase
{
	...
	//! @brief Full channel descriptions, as a vector of structures
	vector<ChannelFullDesc> mChannelsFull;
